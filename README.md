...
| `lib/portfolio.js` | 홈 집계와 분류(금융/실물 · 원금 보장 · 현금화 · 성장 가능성) |
...
도넛이 아니라 **가로 누적 막대**입니다. 도넛은 조각끼리 구분이 어렵고, 비중 2%짜리 조각은 모바일에서 폭이 몇 픽셀이라 진입점으로 쓸 수 없었습니다. 진입은 금액·비율이 함께 적힌 **범례 행**이 맡고, 터치 타겟은 44px 이상입니다.
