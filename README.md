...
`오늘의 주요 뉴스`·`주요 경제지표`·`다가오는 일정` 세 칸은 골격과 `준비 중` 표시만 있고 데이터 연동은 다음 단계입니다.
...
`다가오는 일정`은 자산 만기가 아니라 **거시 경제 일정**(FOMC 금리 발표, CPI·고용지표)입니다. 자산 만기는 총자산 아래의 `확인이 필요한 항목` 줄이 맡습니다.
